...
namespace Vaccination.DataAccess.Repositories
{
    public class BaseRepository<T> : IBaseRepository<T> where T : BaseEntity
    {
        ...
        /// <summary>
        /// Test this as if this function can fix the issue of throw an exception 
        /// (such as InvalidOperationException) because it's already tracking an entity with the same key.
        /// </summary>
        /// <param name="entity"></param>
        //public void Update(T entity)
        //{
        //    var entityTracking = _dbSet.Find(entity.Id);
        //    _dbSet.Entry(entityTracking).State = EntityState.Detached; // Detach the first instance
